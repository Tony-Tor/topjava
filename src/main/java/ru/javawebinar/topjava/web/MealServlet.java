...
public class MealServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LocalDate startData = parseDate(request.getParameter("startData"));
        LocalDate endData = parseDate(request.getParameter("endData"));
        ...
        switch (action == null ? "all" : action) {
            ...
            default:
                log.info("getAll");
                request.setAttribute("meals", controller.getFiltered(startData, endData, startTime, endTime));
